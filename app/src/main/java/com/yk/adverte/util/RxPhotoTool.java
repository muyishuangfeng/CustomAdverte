...
import static com.yk.adverte.util.RxFileTool.getDataColumn;
import static com.yk.adverte.util.RxFileTool.isDownloadsDocument;
import static com.yk.adverte.util.RxFileTool.isExternalStorageDocument;
import static com.yk.adverte.util.RxFileTool.isGooglePhotosUri;
import static com.yk.adverte.util.RxFileTool.isMediaDocument;
...
public class RxPhotoTool {
    ...
    public static Uri createImagePathUri(final Context context) {
        ...
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            ToastUtils.showMessage(context, "请先获取写入SDCard权限");
        } else {
...
//            Cursor cursor = context.getContentResolver().query(uri, new String[]{MediaStore.Images.ImageColumns.DATA}, null, null, null);
    ...
    public static void initUCrop(Context context, Uri uri) {
        try {
            File dir = new File(Constants.HEAD_PIC_PATH);
            if (!dir.exists()) {
                dir.mkdirs();
            }
            File file = new File(Constants.HEAD_PIC_PATH,
                    "head.png");
            if (file.exists()) {
                file.delete();
            }
     ...
     * @param uri
     */
    public static void initUCropOrImage(Context context, Uri uri) {
        try {
            File dir = new File(Constants.CHANNEL_PIC_PATH);
            if (!dir.exists()) {
                dir.mkdirs();
            }
            SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddHHmmss");
            String format = sdf.format(System.currentTimeMillis());
            File file = new File(Constants.CHANNEL_PIC_PATH,
                    format + ".png");
            if (file.exists()) {
                file.delete();
            }
     ...
     * @return
     */
    public static File loadImageView(Context context, Uri uri, ImageView imageView) {
        GlideUtils.loadUri(context,
                uri,
