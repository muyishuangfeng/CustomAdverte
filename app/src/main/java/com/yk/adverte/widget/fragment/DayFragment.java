...
public class DayFragment extends BaseFragment {
    ...
    protected void initView(View view) {
        ...
        mRlvContent = view.findViewById(R.id.rlv_day);
        mTxtCharge = view.findViewById(R.id.txt_day_charge);
        mBtnSure = view.findViewById(R.id.btn_day_sure);
        mEdtRemark = view.findViewById(R.id.edt_day_remark);
        mEdtSlogan = view.findViewById(R.id.edt_day_slogan);
    ...
    private void setAdapter() {
        ...
        mRlvContent.setLayoutManager(mManager);
        ...
        mAdapter.setOnItemClickListener(new ImageAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, View v) {
                ...
                switch (mediaType) {
                    case 1:
                        // 预览图片
                        PictureSelector.create(DayFragment.this).themeStyle(themeId)
                                .openExternalPreview(position, mList);
                        break;
                    case 2:
                        // 预览视频
                        PictureSelector.create(DayFragment.this).externalPictureVideo(media.getPath());
                        break;
                    case 3:
                        // 预览音频
                        PictureSelector.create(DayFragment.this).externalPictureAudio(media.getPath());
                        break;
                }
            }
        });
    ...
    private ImageAdapter.onAddPicClickListener onAddPicClickListener =
            new ImageAdapter.onAddPicClickListener() {
                ...
                public void onAddPicClick() {
                    ...
                    PictureSelector.create(DayFragment.this)
