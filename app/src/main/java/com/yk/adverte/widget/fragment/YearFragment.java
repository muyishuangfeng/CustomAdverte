...
public class YearFragment extends BaseFragment {
    ...
    protected void initView(View view) {
        ...
        mRlvYear = view.findViewById(R.id.rlv_year);
        mTxtCharge = view.findViewById(R.id.txt_year_charge);
        mBtnSure = view.findViewById(R.id.btn_year_sure);
        mEdtRemark = view.findViewById(R.id.edt_year_remark);
        mEdtSlogan = view.findViewById(R.id.edt_year_slogan);
    }
    ...
    private void setAdapter() {
        ...
        mRlvYear.setLayoutManager(mManager);
        ...
        mAdapter.setOnItemClickListener(new ImageAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, View v) {
                ...
                switch (mediaType) {
                    case 1:
                        // 预览图片
                        PictureSelector.create(YearFragment.this).themeStyle(themeId)
                                .openExternalPreview(position, mList);
                        break;
                    case 2:
                        // 预览视频
                        PictureSelector.create(YearFragment.this).externalPictureVideo(media.getPath());
                        break;
                    case 3:
                        // 预览音频
                        PictureSelector.create(YearFragment.this).externalPictureAudio(media.getPath());
                        break;
                }
            }
        });
        mRlvYear.setAdapter(mAdapter);
    }
    ...
    private ImageAdapter.onAddPicClickListener onAddPicClickListener =
            new ImageAdapter.onAddPicClickListener() {
                ...
                public void onAddPicClick() {
                    ...
                    PictureSelector.create(YearFragment.this)
